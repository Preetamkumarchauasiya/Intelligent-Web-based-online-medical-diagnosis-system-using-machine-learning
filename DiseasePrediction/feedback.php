...
if($lastInsertId)
{
    ...
    header('Refresh: 0;url=http://localhost/MedicineShoppee/app/diseases/home');
}
else 
{
            ...
            <div class="row " style="margin-top: 50px">
                <div class="col-md-6 col-md-offset-3 form-container">
                    ...
                    <form role="form" method="post" id="reused_form">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <button type="submit"  name="submit" id="submit" class="btn btn-lg btn-block result-color1" style="background-color:#10847e; color:white;" >SEND</button>
                            </div>
                        </div>
                    </form>
