...
background: -moz-linear-gradient(top,  #bce0ee 33%, #10847e 67%); /* FF3.6-15 */
background: -webkit-linear-gradient(top,  #bce0ee 33%,#10847e 67%); /* Chrome10-25,Safari5.1-6 */
background: linear-gradient(to bottom,  #bce0ee 33%,#10847e 67%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
...
background: #10847e; /* Old browsers */
background: -moz-linear-gradient(top,  #10847e 50%, #bce0ee 90%); /* FF3.6-15 */
background: -webkit-linear-gradient(top,  #10847e 50%,#bce0ee 90%); /* Chrome10-25,Safari5.1-6 */
background: linear-gradient(to bottom,  #10847e 50%,#bce0ee 90%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#10847e', endColorstr='#bce0ee',GradientType=0 ); /* IE6-9 */
...
<div class="flex-p">
    <div class="content-p">
        <ul> 
            <li><h2>Hi There!!!</h2></li>
            <li><p>Welcome to Medicine Shoppee, your one-stop solution for detecting diseases based on symptoms!<br><br>
    ...
    <div class="image-p">
        <div>
            <img src="images/Diabetes-rafiki.png" width="100%" height="100%">
        </div>
